...
const createEmployeeController_1 = require("../controller/createEmployeeController");
...
createEmployeeRoute.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newEmployee = yield (0, createEmployeeController_1.addNewEmployee)(req, res);
...
//# sourceMappingURL=createEmployeeRoute.js.map